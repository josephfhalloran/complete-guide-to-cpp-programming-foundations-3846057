...
// Overloaded function to get speed when distance not provided
int getSpeed(double time){
    return static_cast<int>(100 / time); // assuming default distance of 100 units
}

// Overloaded function to get in format
